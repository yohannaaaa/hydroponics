...
import { Thermometer, Droplets, Activity, Fan } from "lucide-react";
          ...
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-green-600 dark:text-green-400 flex items-center text-xs md:text-sm">
                  <Activity className="h-4 w-4 mr-1" /> Optimal
                </span>
              </div>
            </div>
          </div>
